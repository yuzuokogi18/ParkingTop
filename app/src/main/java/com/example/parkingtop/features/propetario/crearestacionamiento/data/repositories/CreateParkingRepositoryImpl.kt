        ...
        return try {
            ...
            if (data.images.isEmpty()) {
                ...
                val response = api.createParkingWithImages(
                    ...
                    latitude = data.latitude.toNumPart(),
                    longitude = data.longitude.toNumPart(),
                    totalSpots = data.totalSpots.toNumPart(),
                    basePricePerHour = data.basePricePerHour.toNumPart(),
                    overtimeRatePerHour = data.overtimeRatePerHour.toNumPart(),
